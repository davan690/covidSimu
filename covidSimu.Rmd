...
download.file("https://data.public.lu/fr/datasets/r/bdcdc4dd-2922-415e-a075-d0367588f1d8", temp_xlsx)
...
selectInput(inputId = "seriesName_sante",
            ...
            multiple = TRUE, selected = c("Total patients COVID ayant quitté l'hôpital (y compris hospitalisations de courte durée)"))
